...
function ProjectCard({ project }) {
  ...
  return (
    <div className="relative rounded-lg border bg-gradient-to-r from-[#1e2a38] to-[#0a0d37] border-[#2e3a50] w-full max-w-xl mx-auto h-full overflow-hidden shadow-lg">
      ...
      <div className="px-4 lg:px-8 py-3 lg:py-5 relative">
        <div className="flex flex-row space-x-1 lg:space-x-2 absolute top-1/2 -translate-y-1/2">
          <div className="h-2 w-2 lg:h-3 lg:w-3 rounded-full bg-violet-300"></div>
